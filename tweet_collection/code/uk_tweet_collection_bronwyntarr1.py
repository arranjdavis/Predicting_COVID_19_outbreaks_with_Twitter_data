...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 19 16:41:56 2021
...
#create a date range from 1 November 2019 to 1 April 2021 (pre-pandemic and early pandemic)
first_day = date(2019,11,1)
last_day = date(2021,4,1)
...
all_dates = early_pandemic_days + flu_2018 + flu_2017 + flu_2016
...
progress_output = '../progress/dates_collected_uk.txt'

#load or create a list to track collection progress (a dataset will be saved for each day)
try:
    dates_saved = pickle.load(open("../progress/dates_saved_uk.pkl", "rb"))
except:
    dates_saved = [] 
...
for day in remaining_days:
    ...
    with open('../progress/dates_saved_uk.pkl', 'wb') as f:
